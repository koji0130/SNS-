...
<div class="icons">
  <div class="icon-list">@foreach ($user as $list) @if ($list->id != Auth::user()->id) @if (auth()->user()->isFollowing($list->id))
...
<div class="posts-index">@foreach ($post as $list) @if (Auth::user()->isFollowing($list->user->id) ) @if ($list->user->id != Auth::user()->id)
  <div class="posts">
